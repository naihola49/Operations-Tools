...
An attempt to further my passion for operational excellence and efficiency found during my gap year from Harvard. This repo is used to distill information from readings + program models I find interesting. Repo created in Spring 2026; updates to come with future projects undertaken during remaining gap + senior year.
